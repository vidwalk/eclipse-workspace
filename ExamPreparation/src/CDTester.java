...
public class CDTester
{
   ...
   public static void main(String[] args)
   {
      ...
      boolean testConstructorComposition = trackToString.toString().equals("Track Artist - Track Title (04:04:04)");
      ...
      boolean testTrackGetLengthComposition = trackGetLengthComposition.getLength().getHour() == 4 && trackGetLengthComposition.getLength().getMinute() == 4 && trackGetLengthComposition.getLength().getSecond() == 4;
